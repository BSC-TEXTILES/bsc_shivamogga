...
export default function GalaDinner() {
  ...
  return (
    <section className="section gala" id="gala" data-reveal-section aria-labelledby="gala-title">
      <div className="container narrow">
        <div className="event-banner">
          <p className="eyebrow" data-reveal>EVENING RECEPTION</p>
          <h2 id="gala-title" data-reveal>BUSINESS PARTNER’S GALA DINNER</h2>
          <span className="rule" aria-hidden="true" />

          <p className="gala-intro" data-reveal>
          ...
          <div className="gala-actions-wrapper" data-reveal>
